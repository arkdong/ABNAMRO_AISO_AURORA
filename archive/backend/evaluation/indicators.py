...
PASSING_VALUES: dict[type[Enum], set[Enum]] = {
    ...
    AmbiguityScale: {AmbiguityScale.none_, AmbiguityScale.few},
    ...
    ExclusionScale: {ExclusionScale.exclusion, ExclusionScale.no_exclusion},  # neutral: tag presence is what matters; the check itself decides
