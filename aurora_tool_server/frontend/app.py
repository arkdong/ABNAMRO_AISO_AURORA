...
st.markdown(
    '<h2 style="margin:0.25rem 0 0.1rem 0;color:#004C4C;letter-spacing:0.06em;">AURORA</h2>'
    '<p style="margin:0 0 1.2rem 0;color:#6b7280;font-size:0.9rem;">Editorial content intelligence platform</p>',
    unsafe_allow_html=True,
)
...
with st.sidebar:
    st.markdown(
        ...
        f'{_ABN_SHIELD_IMG}'
        f'<div style="font-size:1.2rem;font-weight:700;color:#fff;letter-spacing:.08em;margin-top:.4rem;">AURORA</div>'
    ...
    st.session_state["origin"] = st.selectbox(
        ...
        format_func=lambda v: ORIGIN_LABELS.get(v, v),
    )
