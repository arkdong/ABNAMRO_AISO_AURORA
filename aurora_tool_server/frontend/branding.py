"""ABN AMRO branding for AURORA Streamlit pages."""
...
ABN_LOGO_IMG = f'<img src="data:image/svg+xml;base64,{_ABN_LOGO_B64}" style="width:170px;height:auto;display:block;margin-bottom:0.5rem;">'

_ABN_SHIELD_SVG = '<svg width="30" height="38" viewBox="0 0 54 73" xmlns="http://www.w3.org/2000/svg"><path d="M27.12 72.1 54.09 45.08V.04H.04v45.04Z" fill="#00A296"/><path d="m54.09 45.08-26.97-27V72.1Z" fill="#F3C000"/></svg>'
_ABN_SHIELD_B64 = base64.b64encode(_ABN_SHIELD_SVG.encode()).decode()
ABN_SHIELD_IMG = f'<img src="data:image/svg+xml;base64,{_ABN_SHIELD_B64}" style="width:30px;height:38px;">'
...
def apply_branding(title: str, subtitle: str) -> None:
    ...
    st.markdown(ABN_LOGO_IMG, unsafe_allow_html=True)
    st.markdown(
        f'<h2 style="margin:0.25rem 0 0.1rem 0;color:#004C4C;letter-spacing:0.06em;">{title}</h2>'
