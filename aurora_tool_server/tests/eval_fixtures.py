...
def make_snippets() -> list[Snippet]:
    return [
        Snippet(
            ...
            article_title="The two faces of Agentic AI",
            source_url="https://www.abnamro.nl/article-agentic-ai.html",
        ...
        Snippet(
            ...
            article_title="Cybersecurity in TMT",
            source_url="https://www.abnamro.nl/article-cybersecurity-tmt.html",
