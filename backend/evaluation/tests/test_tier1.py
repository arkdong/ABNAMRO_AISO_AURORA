...
from backend.evaluation.tier1_deterministic import (
...
def test_sentence_length_passes_short_sentences():
    req = make_request()
    gen = make_generation(body="Short sentence. Another short one. Three words here.")
